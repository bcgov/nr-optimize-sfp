...
> - **all 7** of the NRM Ministry .csv files for the quarterly report on H Drives. The file names look like this: **<Ministry acronym>-U FileTypeCategory Summary Report**. <br> Make sure the source files all relate to the same timeframe, because the script reads in all files that end in *-U FileTypeCategory Summary Report*.
>
