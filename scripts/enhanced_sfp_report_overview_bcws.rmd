...
*   The amount of data being analyzed in the `r {params$ministry}` SFP is `r {sfpsize}` GB.
...
- [Fiscal Year 2023-2024 Chart of NRM SFP Consumption](http://nrmccp-metabase.apps.silver.devops.gov.bc.ca/public/question/d376a04d-2d7b-4277-8548-e90e577c131f)  

- [Fiscal Year 2022-2023 Chart of NRM SFP Consumption](http://nrmccp-metabase.apps.silver.devops.gov.bc.ca/public/question/dd440f8a-b7df-4faf-9eea-0a93a8bc5366) 
...
addStyle(excel, sheet = 1, sty1, rows=2:(nrow(table_sfp_share)+1), cols=4)
