...
setColWidths(excel, sheet = 5, c(1:2), widths = c(20, 20))
...
addStyle(excel, sheet = 3, sty1, rows=2:(nrow(table_sfp)+1), cols=5)
addStyle(excel, sheet = 4, sty1, rows=2:(nrow(table_sfp)+1), cols=5)
