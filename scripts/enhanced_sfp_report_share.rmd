...
#dup_orig_cost <- round(sum(dup_new$monthly_cost),2) # cost of each original file that has a duplicate
#dup_cost_diff <- duplicate_cost - dup_orig_cost # cost of ONLY the duplicated files, excluding originals
#dup_cost <- dollar(dup_cost_diff)
```
